...
namespace PictureAnalyzer.DAL
{
    public class PictureAnalyzerInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<PictureAnalyzerContext>
    {
        protected override void Seed(PictureAnalyzerContext context)
        {
            ...
            {
            new Color{Name="Red",Description="",PersonalityTraits="",},
            new Color{Name="Orange",Description="",PersonalityTraits="",},
            new Color{Name="Yellow",Description="",PersonalityTraits="",},
            new Color{Name="Green",Description="",PersonalityTraits="",},
            new Color{Name="Blue",Description="",PersonalityTraits="",},
            new Color{Name="Purple",Description="",PersonalityTraits="",},
            new Color{Name="White",Description="",PersonalityTraits="",},
            new Color{Name="Black",Description="",PersonalityTraits="",},
            new Color{Name="Gold",Description="",PersonalityTraits="",},
            new Color{Name="Silver",Description="",PersonalityTraits="",}
            };
